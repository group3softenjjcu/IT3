<%@ Page Title="" Language="C#" MasterPageFile="~/ABC/Admin/ABCAdmin.Master" AutoEventWireup="true" CodeFile="EditAppointment.aspx.cs" Inherits="University.ABC.EditAppointment" %>
                    ...
                    <ContentTemplate>
                         ...
                         <table style="width:100%; display:block;" >
                            ...
                            <tr>
                                ...
                                <td><asp:Label ID="LabelTime" runat="server" CssClass="label"></asp:Label></td>
                            </tr>
                            <tr>
                                ...
                                <td><asp:Label ID="LabelRoom" runat="server" CssClass="label"></asp:Label></td>
                            </tr> 
                             <tr>
                            ...
                            <tr>    
                                <th></th>            
                                <td><asp:ImageButton ID="ImageButtonCreate" runat="server"  ImageUrl="~/ABC/Admin/images/function/update.jpg" OnClick="ImageButtonCreate_Click" /></td>                
                                 <td />
                            </tr>
                          </table>
                    </ContentTemplate>
