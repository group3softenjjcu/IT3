            ...
            else{
            {
                ...
                if (active)
                {
                    if (student.checkAccount(username,password,phone,email))
                    {
                        ...
                        ClientScript.RegisterStartupScript(this.GetType(), "Alert", "<script type='text/javascript'>alert('Login successful, you can view your profile now...');window.location='Home.aspx';</script>'");
                    }
                    else
                    ...
                    ClientScript.RegisterStartupScript(this.GetType(), "Alert", "<script type='text/javascript'>alert('You account has been deactived or hasn't been registered yet, please contact administrator or student service!!!');window.location='Home.aspx';</script>'");                
            }
