<%@ Page Title="" Language="C#" MasterPageFile="~/UOE/Admin/Admin.Master" AutoEventWireup="true" CodeFile="EditAppointment.aspx.cs" Inherits="University.UOE.EditAppointment" %>
                  ...
                  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                         ...
                         <table style="width:100%; display:block;" >
                            ...
                            <tr>    
                                <th></th>            
                                <td><asp:ImageButton ID="ImageButtonCreate" runat="server"  ImageUrl="~/UOE/Admin/images/function/update.jpg" OnClick="ImageButtonCreate_Click" /></td>                
                                 <td />
                            </tr>
                          </table>
                    </ContentTemplate>
